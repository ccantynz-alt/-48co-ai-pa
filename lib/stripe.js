 ...
 *   NEXT_PUBLIC_APP_URL     — Your domain (https://48co.nz)
 */
import Stripe from 'stripe'

if (!process.env.STRIPE_SECRET_KEY) {
  throw new Error('STRIPE_SECRET_KEY is required. Add it to your environment variables.')
}
...
export const APP_URL = process.env.NEXT_PUBLIC_APP_URL || 'https://48co.nz'
