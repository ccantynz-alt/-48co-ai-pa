      ...
      <div className="max-w-5xl mx-auto px-4 pt-32 pb-16">
        <div className="text-center mb-14">
          <h1 className="text-4xl md:text-5xl font-bold text-navy-900 mb-4">
            How <span className="text-gold-500">48co</span> compares
          </h1>
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="border-b border-gray-100 bg-[#FAFAF8]">
                <th className="text-left py-3.5 px-4 text-gray-500 font-medium w-[180px]">Feature</th>
                <th className="text-center py-3.5 px-4 text-navy-900 font-bold">48co</th>
                <th className="text-center py-3.5 px-4 text-gray-400 font-medium">Grammarly</th>
                <th className="text-center py-3.5 px-4 text-gray-400 font-medium">Wispr Flow</th>
                <th className="text-center py-3.5 px-4 text-gray-400 font-medium">SuperWhisper</th>
              </tr>
            </thead>
            <tbody>
              {features.map((f) => (
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-6">
          ...
          <div className="rounded-xl p-7 border-2 border-navy-200 bg-navy-50/30 md:col-span-2">
            <h2 className="text-[15px] font-bold text-navy-900 mb-5">Where 48co wins</h2>
