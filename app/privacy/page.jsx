    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-36 pb-20">
        ...
        <div className="prose prose-gray prose-sm max-w-none [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-navy-900 [&_h2]:mt-10 [&_h2]:mb-4 [&_p]:text-gray-600 [&_p]:leading-relaxed [&_p]:mb-4 [&_ul]:text-gray-600 [&_ul]:mb-4 [&_li]:mb-1">
          ...
          <ul className="list-disc pl-6">
            <li><strong>Anthropic (Claude AI):</strong> Processes grammar checks and rewrites. Subject to <a href="https://www.anthropic.com/privacy" className="text-navy-700 hover:text-navy-900 font-medium" target="_blank" rel="noopener">Anthropic&rsquo;s privacy policy</a>.</li>
            <li><strong>OpenAI (Whisper):</strong> Processes voice transcription when you choose the Whisper engine. Subject to <a href="https://openai.com/privacy" className="text-navy-700 hover:text-navy-900 font-medium" target="_blank" rel="noopener">OpenAI&rsquo;s privacy policy</a>.</li>
            <li><strong>Stripe:</strong> Processes payments. We never see or store your card details. Subject to <a href="https://stripe.com/privacy" className="text-navy-700 hover:text-navy-900 font-medium" target="_blank" rel="noopener">Stripe&rsquo;s privacy policy</a>.</li>
          ...
          <h2>Your Rights</h2>
          <p>You can request deletion of your account and all associated data at any time by contacting <a href="mailto:support@48co.nz" className="text-navy-700 hover:text-navy-900 font-medium">support@48co.nz</a>. We will delete your data within 30 days of receiving your request.</p>
          ...
          <h2>Contact</h2>
          <p>For privacy questions or data requests, email <a href="mailto:support@48co.nz" className="text-navy-700 hover:text-navy-900 font-medium">support@48co.nz</a>.</p>
        </div>
      </div>
      <Footer />
    </main>
