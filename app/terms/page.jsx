  ...
  return (
    <main className="min-h-screen bg-navy-950">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-32 pb-16">
        ...
        <div className="space-y-8 text-[14px] text-white/30 leading-relaxed">
          ...
          <section>
            ...
            <p>You must provide accurate information when creating an account. You are responsible for maintaining the confidentiality of your login credentials. Notify us immediately at <a href="mailto:support@alecrae.ai" className="text-gold-400/70 hover:text-gold-400">support@alecrae.ai</a> if you suspect unauthorised access to your account.</p>
          </section>
          ...
          <section>
            ...
            <p>For questions about these terms, contact <a href="mailto:legal@alecrae.ai" className="text-gold-400/70 hover:text-gold-400">legal@alecrae.ai</a>.</p>
          </section>
