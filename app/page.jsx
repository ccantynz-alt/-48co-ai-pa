    ...
    <main className="min-h-screen bg-navy-950 overflow-x-hidden">
      ...
      <section className="pt-40 pb-32 px-6 md:px-8 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <p className="text-[17px] text-white/30 max-w-lg mx-auto leading-relaxed mb-12 animate-fade-up" style={{ animationDelay: '0.15s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-20 animate-fade-up" style={{ animationDelay: '0.25s' }}>
            ...
            <a href="/security" className="px-8 py-3.5 rounded-xl border border-white/8 text-white/40 text-[15px] font-medium hover:border-white/15 hover:text-white/60 transition-all">
              View Security
            </a>
          </div>
          ...
          <div className="max-w-xl mx-auto animate-fade-up" style={{ animationDelay: '0.35s' }}>
            <div className="rounded-2xl overflow-hidden bg-white/[0.03] border border-white/[0.06]">
              <div className="flex items-center justify-between px-5 py-3 border-b border-white/[0.04]">
                <span className="text-[11px] text-white/20 font-mono">{typing.label}</span>
                <span className={`w-2 h-2 rounded-full ${typing.isTyping ? 'bg-gold-400' : 'bg-white/20'}`} />
              </div>
              <div className="px-5 py-3 border-b border-white/[0.03]">
                <p className="text-[13px] text-white/20 leading-relaxed line-through decoration-white/10">{typing.before}</p>
              </div>
              <div className="px-5 py-4">
                <p className={`text-[14px] text-white/70 leading-relaxed whitespace-pre-wrap min-h-[44px]`}>
          ...
          <p className="text-[11px] text-white/15 mt-10 tracking-wide">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="rounded-xl border border-white/[0.04] overflow-hidden">
                <div className="px-5 py-2 border-b border-white/[0.03]">
                  <span className="text-[10px] text-white/15 font-medium uppercase tracking-wider">{ex.context}</span>
                </div>
                <div className="grid md:grid-cols-2">
                  <div className="p-5 border-b md:border-b-0 md:border-r border-white/[0.03]">
                    <p className="text-[13px] text-white/20 leading-relaxed">{ex.before}</p>
                  </div>
                  <div className="p-5">
                    <p className="text-[13px] text-white/60 leading-relaxed">{ex.after}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section ref={r4} className="reveal py-28 px-6 md:px-8 border-t border-white/[0.04]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a href="/pricing" className="inline-block mt-8 text-[13px] text-white/25 hover:text-white/50 transition-colors">
      ...
      <section ref={r5} className="reveal py-28 px-6 md:px-8 border-t border-white/[0.04]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-white/20 text-[15px] mb-10 max-w-md mx-auto leading-relaxed">
